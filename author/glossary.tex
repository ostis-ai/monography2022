...
\begin{scnreltolist}{ключевой знак}
	\scnitem{Глава \ref{sec_chapter_enterprise_smart_industry}~\nameref{sec_chapter_enterprise_smart_industry}}
\end{scnreltolist}
...
\begin{scnreltolist}{ключевой знак}
	\scnitem{\ref{scnrelfromlist}~\nameref{scnrelfromlist}}
\end{scnreltolist}
